    ...
    <div className="bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32">
      <div className="flex flex-wrap justify-between gap-12 md:gap-6">
        <div className="max-w-80">
          ...
          <p className="text-sm">
            Discover the world's most extraordinary places to stay with QuickStay, your trusted partner for luxury accommodations and unforgettable travel experiences.
          </p>
        ...
        <div className="max-w-80">
          ...
          <div className="flex items-center mt-4">
            ...
            <button className="flex items-center justify-center bg-black h-9 w-9 aspect-square rounded-r">
              <img src={assets.arrowIcon} alt="arrow-icon" className="w-4 h-4 filter invert"/>
            </button>
          </div>
        </div>
      </div>
