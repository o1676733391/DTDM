  ...
  return (
    <div className="relative max-w-70 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadow-[0px_4px_4px_rgba(0,0,0,0.05)]">
      <Link
        ...
        className="block"
      >
        <img src={room.images && room.images.length > 0 ? room.images[0] : '/placeholder-room.jpg'} alt="" />
        ...
        <div className="p-4 pt-5">
          <div className="flex items-center justify-between">
            <p className="font-playfair text-xl font-medium text-gray-800">
              {room.hotels?.name || room.room_type || 'Hotel Room'}
            </p>
          ...
          <div className="flex items-center gap-1 text-sm">
            ...
            <span className="whitespace-nowrap">{room.hotels?.address || room.hotels?.city || 'Location'}</span>
          </div>
